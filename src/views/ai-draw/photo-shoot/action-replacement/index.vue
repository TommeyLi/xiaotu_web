...
async function findStyleById(id: any) {
  try {
...
onMounted(async () => {
  ...
  getFilterOptions()
  if (route.query.id) {
    const found = await findStyleById(route.query.id as string)
    if (found)
  ...
  <div class="w-full h-full flex">
    <div class="setting-list relative">
      ...
      >
        <div class="scrollbar-content">
          <span class="headline">
            选择特效
            <span class="subhead">（替换妆照+动作）</span>
          </span>
    ...
    >
      ...
      >
        ...
        >
        <span class="font-['PingFang_SC'] c-[rgba(0,0,0,0.85)] text-14px">生成的结果，仅包括人物的妆造和动作部分，不包括背景</span>
      </div>
